...
```{r requirements1, message=FALSE, warning=FALSE, eval=FALSE, include=FALSE}
library(kableExtra)
# col1 <- c("","Attendance & Participation","Presentation","Essay"),
kable(data.frame(
...
<!-- 2025-6 -->
<!-- - Some research suggests nonviolent strategies are more effective than violent strategies in helping to achieve political goals. Reflect on this thesis: why might nonviolence be more effective? What arguments support it? What speaks against it? -->
<!-- - What policies (e.g., legislation, social programmes--not repressive measures) can be used to address (potential) political violence? Explain how such policies might affect ongoing and/or potential political violence in a society. -->
<!-- - Briefly define the concepts of radicalisation, engagement, deradicalisation, and disengagement as they relate to political violence. Describe the causal factors that might lead individuals to radicalise and engage, and to disengage and deradicalise. -->

<!-- - What are the factors can help cause political violence and terrorism? Discuss macro-level, meso-level, and micro-level factors with brief examples. -->
<!-- - What does the term ‘foreign fighter’ mean? Who becomes a foreign fighter? How can ‘home’ countries deal with returning foreign fighters?  -->
<!-- - Describe how the Internet has been used by politically violent groups/actors. What are possible ways of addressing this online activity?  -->


<!-- 2024-5 -->
<!-- - What are the factors can help cause political violence and terrorism? Discuss macro-level, meso-level, and micro-level factors with brief examples.	 -->
<!-- - What does the term ‘foreign fighter’ mean? Who becomes a foreign fighter? How can ‘home’ countries deal with returning foreign fighters? -->
<!-- - One way states respond to violent or threatening organisations is by banning them. What influences whether a state bans (or designates as 'terrorist') politically violent organisations? Discuss, with examples, the effects that a ban can have on politically violent actors and wider society. -->
<!-- - What policies (e.g., legislation, social programmes--not repressive measures) can be used to address (potential) political violence? Explain how such policies might affect ongoing and/or potential political violence in a society.  -->
<!-- - Briefly define the concepts of radicalisation, engagement, deradicalisation, and disengagement as they relate to political violence. Describe the causal factors that might lead individuals to radicalise and engage, and to disengage and deradicalise. -->
<!-- - Some research suggests nonviolent strategies are more effective than violent strategies in helping to achieve political goals. Reflect on this thesis: why might nonviolence be more effective? What arguments support it? What speaks against it? -->
...
<!-- - Briefly define the concepts of radicalisation, engagement, deradicalisation, and disengagement as they relate to political violence. Describe the causal factors that might lead individuals to radicalise and engage, and to disengage and deradicalise. 	 -->
<!-- - Some research suggests nonviolent strategies are more effective than violent strategies in helping to achieve political goals. Reflect on this thesis: why might nonviolence be more effective? What arguments support it? What speaks against it? -->
<!-- - States can respond to political violence with repression. Discuss, with examples, the effects that state repression can have on politically violent actors and wider society. -->
<!-- - Describe how the Internet has been used by politically violent groups/actors. What are possible ways of addressing this online activity?  -->
<!-- - Some research suggests violent strategies (and the activity of 'radical flanks') are effective ways for movements/actors to achieve political goals. Reflect on this thesis: what arguments support it? What speaks against it?  -->
<!-- - What policies (e.g., legislation, social programmes--not repressive measures) can be used to address (potential) political violence? Explain how such policies might affect ongoing and/or potential political violence in a society. -->

Students will not have an examination in this course, but they will in the '**Einführung Politisches System der BRD**' course. During that examination, they will respond to one or more essay questions based on the content of this course. [Please ensure you check the date and time of the exam---and that you register for the exam on time]{style="color:red;"}.
...
**Once you have read this far: please send me an email before the second class stating your favourite city and what (if any) politically violent groups you are particularly interested in learning about.**
